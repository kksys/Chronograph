...
public struct ChronographView: View {
	...
	public var body: some View {
		GeometryReader { geometry in
			ZStack {
				DateWheel()
					.background(.Chronograph.background)
					.date(.Chronograph.foreground)
				...
				ChronographBackground()
					.background(.Chronograph.background.opacity(0.9))
					.foreground(.Chronograph.foreground)
...
private struct ChronographView_Preview: View {
	...
	var body: some View {
		VStack {
			ChronographView(date: $viewModel.date, batteryInfo: $viewModel.batteryInfo)
				.padding(.all, 10)
...
struct ChronographView_Previews: PreviewProvider {
    static var previews: some View {
		ZStack {
			ChronographView_Preview(viewModel: ContentViewModel1())
				.padding(.all, 10)
		}
		.frame(width: 500, height: 500)
		...
		ZStack {
			ChronographView_Preview(viewModel: ContentViewModel2())
				.padding(.all, 10)
		}
		.frame(width: 500, height: 500)
		.previewLayout(.fixed(width: 500, height: 500))
		...
		ZStack {
			ChronographView_Preview(viewModel: ContentViewModel3())
				.padding(.all, 10)
		}
		.frame(width: 500, height: 500)
		.previewLayout(.fixed(width: 500, height: 500))
		...
		ZStack {
			ChronographView_Preview(viewModel: ContentViewModel4())
				.padding(.all, 10)
		}
		.frame(width: 500, height: 500)
		.previewLayout(.fixed(width: 500, height: 500))
		...
		ZStack {
			ChronographView_Preview(viewModel: ContentViewModel5())
				.padding(.all, 10)
		}
		.frame(width: 500, height: 500)
		.previewLayout(.fixed(width: 500, height: 500))
